...
@register_model
def mobilevitv2_050(pretrained=False, num_classes=1000, distillation=False):
    return MobileViTv2(image_size=(256, 256), width_multiplier=0.5, num_classes=num_classes)

@register_model
def mobilevitv2_075(pretrained=False, num_classes=1000, distillation=False):
    return MobileViTv2(image_size=(256, 256), width_multiplier=0.75, num_classes=num_classes)
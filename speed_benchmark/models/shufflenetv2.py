...
@register_model
def shufflenetv2_100(pretrained=False, num_classes=1000, distillation=False):
    model = ShuffleNetV2(n_class=num_classes, model_size='1.0x')
    return model

@register_model
def shufflenetv2_150(pretrained=False, num_classes=1000, distillation=False):
    model = ShuffleNetV2(n_class=num_classes, model_size='1.5x')
    return model

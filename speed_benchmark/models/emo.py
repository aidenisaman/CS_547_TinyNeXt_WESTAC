...
@register_model
def emo_1m(pretrained=False, num_classes=1000, distillation=False):
    model = EMO(
...
@register_model
def emo_2m(pretrained=False, num_classes=1000, distillation=False):
    model = EMO(
        num_classes=num_classes,
...
@register_model
def emo_5m(pretrained=False, num_classes=1000, distillation=False):
    model = EMO(
        num_classes=num_classes,

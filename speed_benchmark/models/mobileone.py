...
# Just test params flops throughput
@register_model
def mobileone_s0(pretrained=False, num_classes=1000, distillation=False):
    variant_params = PARAMS["s0"]
    model =  MobileOne(num_classes=num_classes, inference_mode=True, **variant_params)
